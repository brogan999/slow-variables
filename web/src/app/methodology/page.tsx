...
export default function Methodology() {
  ...
  return (
    ...
    <section aria-labelledby="read" className="prose-folio drop-cap">
      ...
      <p>Colour carries meaning and never a verdict. Violet with ▲ means faster or concentrating; rust with ▼ means slower or dispersing. Faster is not better and concentrating is not worse; the words and the arrows are always there, so nothing depends on seeing the colour.</p>
