...
import { index, meta, seriesKeys } from "@/lib/data";
import { SITE } from "@/lib/site";

const STATIC = ["", "/capture", "/indicators", "/predictions", "/compare", "/bottlenecks", "/ledger", "/crosswalk", "/sources", "/methodology", "/changelog"];
