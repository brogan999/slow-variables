...
| `deal_sheets.json` | archetype cards + not carded | stance is **reasoned from invoice structure, not measured**; occupation-anchored cards are sized by one occupation; disclosures cover PEOs inside NAICS 5613 and the labs / revenue-cycle overlap (not additive); comps illustrate revenue models |
